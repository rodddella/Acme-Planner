...
<acme:list>
	...
	<acme:list-column code="authenticated.task.list.label.end_period" path="endPeriod" />
	<acme:list-column code="authenticated.task.list.label.visibility" path="visibility" />
</acme:list>
