...
public class PrinterHelper {
	...
	public static void printValue(final StringBuilder buffer, final Object value, final boolean summary) {
		assert buffer != null;
	...
	public static void printRecord(final StringBuilder buffer, final Object object, final boolean summary) {
		assert buffer != null;
		assert object != null;
	...
	public static void printFieldsInClazz(final StringBuilder buffer, final Class<?> clazz, final Object object) {
		assert buffer != null;
		assert clazz != null;
		assert object != null;
	...
	public static void printPrimitive(final StringBuilder buffer, final Object value, final boolean summary) {
		assert buffer != null;
		// value is nullable
	...
	public static void printObjectArray(final StringBuilder buffer, final Object[] value, final boolean summary) {
		assert buffer != null;
		assert value != null;
	...
	public static void printCollection(final StringBuilder buffer, final Collection<?> value, final boolean summary) {
		assert buffer != null;
		assert value != null;
	...
	public static void printType(final StringBuilder buffer, final Object value) {
		assert buffer != null;
		// assert value is nullable;
	...
	public static boolean isCollection(final Object object) {
		...
		result = object instanceof Collection;
