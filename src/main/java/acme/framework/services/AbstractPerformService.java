...
@Service
public interface AbstractPerformService<R extends UserRole, E> extends //
		AbstractService<R, E>, //
		AuthoriseMethod<R, E>, //
		BindMethod<R, E>, UnbindMethod<R, E>, //
		InstantiateMethod<R, E>, //
		ValidateMethod<R, E>, //
		PerformMethod<R, E>, //
	...
	@Override
	E instantiate(final Request<E> request);

	@Override
	void validate(final Request<E> request, final E entity, Errors errors);

	@Override
	void perform(final Request<E> request, final E entity, Errors errors);
